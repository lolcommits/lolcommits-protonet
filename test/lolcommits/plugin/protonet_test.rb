    ...
    def valid_enabled_config
      @config ||= OpenStruct.new(
        read_configuration: {
          "protonet" => {
            "enabled" => true,
            "endpoint" => "https://protonet.com/uplol",
    ...
    describe "run_capture_ready" do
      ...
      it "syncs lolcommits" do
        in_repo do
          ...
          stub_request(:post, "https://protonet.com/uplol").to_return(status: 200)

          plugin.run_capture_ready

          assert_requested :post, "https://protonet.com/uplol", times: 1,
